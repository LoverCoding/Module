...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/珍爱一生520999zzz/MTABaseViewKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '珍爱一生520999zzz' => '980609239@qq.com' }
  s.source           = { :git => 'https://github.com/珍爱一生520999zzz/MTABaseViewKit.git', :tag => s.version.to_s }
